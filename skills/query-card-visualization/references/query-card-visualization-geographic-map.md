      ...
      "properties": {
        ...
        "config": {
          ...
          "properties": {
            ...
            "legend": {
              "description": "Configuration for the map legend. Controls the appearance and behavior of the legend. Legends are ON BY DEFAULT: if omitted, the legend is shown (visible: true, placement: 'bottom'). Only set visible: false to hide it.",
              "default": {},
              "type": "object",
              "properties": {
                "visible": {
