...
JSON schema for the `topList` visualizationTemplate object. The `visualizationTemplate` value MUST be a single object matching this schema (top-level key `topList`). Do not write it from memory; emit exactly this shape.
...
```json
{
  ...
  "properties": {
    "topList": {
      "description": "Configuration for top list visualizations in Vega. Displays a ranked list of items, often with bars to represent values.",
      "type": "object",
      "properties": {
        "key": {
          "description": "The field to use for list item keys. Determines which data field's values will be used as item identifiers.",
          "anyOf": [
            {
              "type": "string",
        ...
        "value": {
          "description": "The field to use for list item values. Determines which data field's values will be displayed and used for sorting.",
          "anyOf": [
            {
              "type": "string",
              "description": "A simple string identifier for a column in a dataset.\n\nThis is the most basic field type, representing a direct reference to a column by its ID.\n\nEXAMPLES:\n- \"timestamp\": Reference to a timestamp column\n- \"status_code\": Reference to a status code column\n- \"user_id\": Reference to a user ID column\n    "
        ...
        "viewConfig": {
          "description": "Configuration for the view. Controls how the list is displayed in different scenarios.",
          "type": "object",
          "properties": {
            "useSingleStatOnSingleGroup": {
              "description": "Whether to display as a single stat when there's only one group. Set to true to show a single value instead of a list for single items.",
              "type": "boolean"
            }
          }
        },
        "keyConfig": {
          ...
          "properties": {
            ...
            "order": {
              "description": "The sort order for list items. Controls whether items are sorted in ascending or descending order.",
              "anyOf": [
                {
                  "type": "string",
                  "const": "descending",
                  "description": "Sorts items in descending order. Shows highest values first."
                },
                {
                  "type": "string",
                  "const": "ascending",
                  "description": "Sorts items in ascending order. Shows lowest values first."
                }
              ]
            },
            "showOthers": {
              "description": "Whether to show an 'Others' category for items beyond the limit. Set to true to aggregate remaining items.",
              "type": "boolean"
            },
            "limit": {
              "description": "The maximum number of items to show. Limits the list to the top N items.",
              "type": "number"
            }
          }
        },
        "valueConfig": {
          ...
          "properties": {
            ...
            "format": {
              "description": "The formatting options for values. Controls how values are displayed in the list."
            },
            "showAxis": {
            ...
            "aggregate": {
              "description": "The aggregation function to use for values. Determines how multiple values are combined.",
              "type": "string"
            }
          }
        },
        "barConfig": {
          "description": "Configuration for bar appearance. Controls how bars are displayed in the list.",
          "type": "object",
          "properties": {
            "bandSize": {
